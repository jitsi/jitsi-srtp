...
public class SrtpValidationTest {
    ...
    @Test
    public void srtpValidateCtrHmac()
    {
    ...
    @Test
    public void rejectInvalidCtrHmac()
    {
        SrtpPolicy policy =
            new SrtpPolicy(SrtpPolicy.AESCM_ENCRYPTION, 128/8,
                SrtpPolicy.HMACSHA1_AUTHENTICATION, 160/8,
    ...
    /* More test cases from libsrtp's srtp_driver.c. */
